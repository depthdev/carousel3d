...
function Carousel3D(o) {
  ...
  var box = $(o.box);
  var points = $$(o.points);
  var pointsPercentOf = o.pointsPercentOf || 0.25;
  ...
  var turn = function(deg) {
    ...
    for (;i<len;i++) {
      ...
      var p = 'position:absolute;z-index:' + z + ';left:' + x + 'px;top:' + y + 'px;' + pointMargin + pointWidthAndHeight +
  ...
  var reset = function() {
    ...
    var boxHeight = boxWidth * perspective;
    box.style.height = boxHeight + 'px';
    // Points size
    var aspectPointWidth = points[0].offsetWidth;
    var aspectPointHeight = points[0].offsetHeight;
    var pointAspectRatio = aspectPointHeight / aspectPointWidth;
    var pointWidthNum = boxWidth * pointsPercentOf;
